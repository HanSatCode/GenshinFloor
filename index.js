...
var fourthUpList = ["바바라", "노엘", "연비"];
var fourthList =  ["레이저", "운근", "응광", "중운", "고로", "향릉", "쿠죠 사라", "토마", "연비", "사유", "신염", "설탕", "로자리아", "디오나", "베넷", "피슬", "행추", "북두", "녹슨 활", "제례활", "절현", "페보니우스 활", "소심", "제례의 악장", "음유시인의 악장", "페보니우스 비전", "페보니우스 장창", "용학살창", "빗물 베기", "제례 대검", "시간의 검", "페보니우스 대검", "용의 포효", "제례검", "피리검", "페보니우스 검"];
var fifthUpList = ["야란"];
