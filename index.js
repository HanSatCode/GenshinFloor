...
var fourthUpList = ["레이저", "로자리아", "사유"];
var fourthList =  ["운근", "응광", "중운", "고로", "바바라", "향릉", "쿠죠 사라", "토마", "연비", "신염", "설탕", "디오나", "노엘", "베넷", "피슬", "행추", "북두", "녹슨 활", "제례활", "절현", "페보니우스 활", "소심", "제례의 악장", "음유시인의 악장", "페보니우스 비전", "페보니우스 장창", "용학살창", "빗물 베기", "제례 대검", "시간의 검", "페보니우스 대검", "용의 포효", "제례검", "피리검", "페보니우스 검"];
var fifthUpList = ["카미사토 아야카"];
...
// 5성확률 0.6%. 카미사토 아야카 확률 50%. 체감상 80회 기원시 반드시 획득. 얻은적 없다면 그다음 무조건.
// 4성확률 5.1%. 레이저 로자리아 사유 확률 50%. 10회 기원시 반드시 획득. 얻은적 없다면 그다음 무조건.
