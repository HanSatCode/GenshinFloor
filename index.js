...
var fourthUpList = ["응광", "헤이조", "토마"];
var fourthList =  ["레이저", "운근", "중운", "고로", "향릉", "쿠죠 사라", "쿠키 시노부", "노엘", "연비", "사유", "신염", "설탕", "로자리아", "디오나", "베넷", "피슬", "행추", "북두", "녹슨 활", "제례활", "절현", "페보니우스 활", "소심", "제례의 악장", "음유시인의 악장", "페보니우스 비전", "페보니우스 장창", "용학살창", "빗물 베기", "제례 대검", "시간의 검", "페보니우스 대검", "용의 포효", "제례검", "피리검", "페보니우스 검"];
var fifthUpList = ["카에데하라 카즈하"];
...
// 5성확률 0.6%. 야란 확률 50%. 체감상 80회 기원시 반드시 획득. 얻은적 없다면 그 다음 무조건 획득.
// 4성확률 5.1%. 바바라 노엘 연비 확률 50%. 10회 기원시 반드시 획득. 얻은적 없다면 그 다음 무조건 획득.
