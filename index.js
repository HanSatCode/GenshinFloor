...
var fourthUpList = ["레이저", "노엘", "베넷"];
var fourthList =  ["북두", "바바라", "향릉", "도리" , "콜레이", "쿠키 시노부" , "운근" , "시카노인 헤이조" , "쿠죠 사라" , "고로" , "사유" , "토마" , "연비" , "로자리아" , "신염" , "설탕" , "디오나" , "중운" , "피슬" , "응광"  , "행추" , "녹슨 활" , "제례활" , "절현" , "페보니우스 활" , "소심" , "제례의 악장" , "음유시인의 악장" , "페보니우스 비전" , "페보니우스 장창" , "용학살창" , "빗물 베기" , "제례 대검" , "시간의 검" , "페보니우스 대검" , "용의 포효" , "제례검" , "피리검" , "페보니우스 검"];
var fifthUpList = ["나히다"];
